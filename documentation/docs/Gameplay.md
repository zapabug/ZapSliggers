# ZapSlinggers: Gameplay Mechanics

This document outlines the core gameplay loop and dynamics for ZapSlinggers.
...
*   Basic ZapSlinggers rules are partially implemented within `useGameLogic`: HP system used as ability resource, ability selection UI/logic works, standard hits trigger win callback.
...
*   **Remaining Implementation Focus:**
    ...
    *   Full ZapSlinggers Rules: Ability effects (Splitter, Gravity, Plastic implementation), round/match win conditions, Sudden Death mechanics.
...
**1. Core Concept (ZapSlinggers Target):**
...
**3. Turn Flow (Target: Simultaneous Turns - Approx. 60s):**
   ...
   - **C. Post-Resolution / Next Turn Prep (Practice Mode / Future Multiplayer):**
     ...
     - (Future: Check round/match win conditions based on ZapSlinggers rules. Start next turn timer or proceed to Sudden Death/End Match).
...
**5. Power-ups & Special Mechanics (ZapSlinggers Target):**
...
**6. Specific Interactions (Target):**
   - Based on ZapSlinggers win conditions (See 5).
