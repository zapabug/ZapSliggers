**Zapslingers Development Roadmap (React/TS/NDK/matter-js - 2D Canvas)**

**Phase 1: Core Zapslingers Mechanics (Local Play - Mostly Complete)**

*   **Goal:** Implement the core local gameplay loop for Zapslingers, including physics, controls, and basic game rules.
*   **Key Steps:**
    ...
    7.  **Zapslingers Rules (Partial):** Implement HP as resource, ability selection UI/logic, basic win condition callback. - *Done*.
...
*   **Goal:** Integrate Nostr for multiplayer, complete Zapslingers ruleset, implement payments, and test thoroughly.
*   **Key Steps:**
    ...
    5.  **Turn Synchronization (Full):** 
        ...
        *   Handle turn timers.
    6.  **Zapslingers Rules Completion:** Implement ability physics effects, full win conditions (HP/Vulnerability), Vulnerability state, ability limits, turn timer/limits, Sudden Death.
...
*   **Key Steps:**
    ...
    3.  **Advanced Levels:** Add SLINGER planets, moving planets.
...
This roadmap reflects the current state where the local Zapslingers core is built, and the focus is now on completing the gameplay rules and integrating Nostr/payments.
